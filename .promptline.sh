...
function __promptline {
  ...
  local c_fg="${wrap}38;5;239${end_wrap}"
  local c_bg="${wrap}48;5;245${end_wrap}"
  local c_sep_fg="${wrap}38;5;245${end_wrap}"
  local warn_fg="${wrap}38;5;239${end_wrap}"
  local warn_bg="${wrap}48;5;9${end_wrap}"
  local warn_sep_fg="${wrap}38;5;9${end_wrap}"
  local x_fg="${wrap}38;5;239${end_wrap}"
  local x_bg="${wrap}48;5;243${end_wrap}"
  local x_sep_fg="${wrap}38;5;243${end_wrap}"
  local y_fg="${wrap}38;5;239${end_wrap}"
  local y_bg="${wrap}48;5;6${end_wrap}"
  local y_sep_fg="${wrap}38;5;6${end_wrap}"
  local z_fg="${wrap}38;5;239${end_wrap}"
