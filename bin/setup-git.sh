...
git config --global alias.l "log --color --graph --pretty=format:'%C(magenta)%h%Creset → %C(black yellow)%d%Creset %C(italic)%s %Creset%Cgreen(%cr) %C(italic blue)<%an>%Creset' --abbrev-commit"
git config --global alias.lg "log -all --color --graph --pretty=format:'%C(magenta)%h%Creset - %C(black yellow)%d %Creset%C(italic)%s %Creset%Cgreen(%cr) %C(italic blue)<%an>%Creset' --abbrev-commit"
git config --global alias.lm "log --color --graph --pretty=format:'%C(magenta)%h%Creset - %C(black yellow)%d%Creset %C(italic)%s %Creset%Cgreen(%cr) %C(italic blue)<%an>%Creset' --abbrev-commit master..."
git config --global alias.lmn "log --color --graph --pretty=format:'%C(magenta)%h%Creset - %C(black yellow)%d%Creset %C(italic)%s %Creset%Cgreen(%cr) %C(italic blue)<%an>%Creset' --abbrev-commit main..."
git config --global alias.lo "log --color --graph --pretty=format:'%C(magenta)%h%Creset - %C(black yellow)%d%Creset %C(italic)%s %Creset%Cgreen(%cr) %C(italic blue)<%an>%Creset' --abbrev-commit origin/HEAD..."
...
git config --global alias.search "log --no-merges -i -E --pretty='%C(magenta)%h%Creset %C(green)(%ad, %Cgreen%cr)%Creset %C(italic blue)<%an>%Creset%C(italic) %s %C(yellow)%d%Creset' --date=format:'%b %d %Y' --grep"
